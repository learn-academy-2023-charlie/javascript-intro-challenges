...
This repository holds the vanilla JavaScript pair programming challenges for the 2023 Charlie cohort.

### Syllabus References  

- [Collaborative Coding](https://github.com/learn-academy-2023-charlie/Syllabus/blob/main/github/pairing-with-github.md)  

- *Starting at Step 7* of [GitHub](https://github.com/learn-academy-2023-charlie/Syllabus/blob/main/github/github.md)  
