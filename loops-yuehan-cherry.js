...
// //     console.log(i);
// // }
// // output: printed 1 - 20 on individual lines

// // Create a for loop that logs every other number from 1 - 20.
// // for (let i = 1; i < 21; i = i + 2) {
// //     console.log(i);
// // }
// // output: printed every other number from 1-19 on individual lines

// // // Create a for loop that logs the result of each number from 1 - 20 tripled.
// // for (let i = 1; i < 21; i++) {
// //     console.log(i*3);
// // }
// // output: 3-60, multiples of 3 only on individual lines 
