...
//     var myOtherNumber = [0]
//     console.log(myOtherNumber.concat(numbers))
...
var myArray = ["kyle","ernesto","cherry"]
var myOtherArray = ["sarah","scott","bea"]

// Write the code that sorts the names in alphabetical order.

// console.log(myArray.concat(myOtherArray).sort())
//output: [ 'bea', 'cherry', 'ernesto', 'kyle', 'sarah', 'scott' ]
